package com.warhammer.wfrpfrontend.books.domain;

import com.warhammer.wfrpfrontend.books.BookType;
...
public class BookService {
    ...
    public Set<Book> findByTitle(String value) {
        return books.stream()
                    .filter(book -> book.getTitle().contains(value))
